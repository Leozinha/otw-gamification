...
import { FETCH_LEADERBOARDREVIEWS, LEADERBOARDREVIEWS_FETCH_SUCCEEDED, LEADERBOARDREVIEWS_FETCH_ERROR } from '../constants/action-types'
import {ENDPOINT} from "../constants/services"

// função para obter os dados da API em formato JSON
function fetchAll() {
    return fetch(ENDPOINT+'leaderboard', {
        headers: {
